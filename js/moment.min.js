        ...
        <div class="calendar__header">
                ...
                <div class="calendar__body">
                    <div class="calendar-grid">
                        ...
                        <div class="grid_header--mobile">
                            <span class="grid__cell grid__cell--header">l</span>
                            <span class="grid__cell grid__cell--header">M</span>
                            <span class="grid__cell grid__cell--header">M</span>
                            <span class="grid__cell grid__cell--header">J</span>
                            <span class="grid__cell grid__cell--header">V</span>
                            <span class="grid__cell grid__cell--header">S</span>
                            <span class="grid__cell grid__cell--header">D</span>
                        </div>
                        <hr>
                        <div class="grid_body">
